...
/**
 * A <code>InfoStateConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link InfoStateConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-11-17T02:27:07+05:30", comments = "Build UNNAMED.2793.f49b6c7")
public abstract class InfoStateConnectorLifecycleInjectionAdapter
    extends InfoStateConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(InfoStateConnectorLifecycleInjectionAdapter.class);
