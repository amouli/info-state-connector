...
package org.mule.modules.infostate.adapters;
...
import org.mule.modules.infostate.generated.adapters.InfoStateConnectorProcessAdapter;
...
public class InfoStateConnectorRestClientAdapter
    extends InfoStateConnectorProcessAdapter
    implements MuleContextAware, Disposable, Initialisable
{
        ...
        throws IOException
    {
        ...
        if ((output!= null)&&(!String.class.isAssignableFrom(String.class))) {
            ...
            try {
                Method reflectedMethod = InfoStateConnector.class.getMethod("getStateInfo", String.class);
                ...
                throw new RuntimeException("Unable to find method named getStateInfo", nsme);
            }
        } else {
